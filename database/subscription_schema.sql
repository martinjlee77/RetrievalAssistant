...
VALUES 
    ('professional', 'Professional', 295.00, 30000, 1, '["All ASC standards", "Research Assistant", "DOCX/PDF output", "Priority support"]'),
    ('team', 'Team', 595.00, 75000, 3, '["All ASC standards", "Research Assistant", "DOCX/PDF output", "Priority support", "Multi-user organization", "Audit logs"]'),
    ('enterprise', 'Enterprise', 1195.00, 180000, 999, '["All ASC standards", "Research Assistant", "DOCX/PDF output", "Dedicated success manager", "Custom SLA", "Azure OpenAI option", "Unlimited internal viewers"]')
...
BEGIN
    ...
    RAISE NOTICE 'Default plans: Professional ($295/30K), Team ($595/75K), Enterprise ($1195/180K)';
END $$;

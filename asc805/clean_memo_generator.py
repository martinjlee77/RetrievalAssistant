...
class CleanMemoGenerator:
    ...
    def combine_clean_steps(self,
        ...
        # Add disclaimer
        memo_lines.extend([
            DisclaimerGenerator.get_top_banner(), "", "# ASC 805 MEMORANDUM",
    ...
    def _generate_docx(self, memo_content: str) -> bytes | None:
        ...
        try:
            ...
            try:
                ...
                # Fallback if style attributes are not available
                logger.warning("Could not set default document style")
    ...
    def display_clean_memo(self,
        ...
        if memo_content and len(memo_content.strip()) > 10:
            ...
            base_filename = f"asc805_memo_{timestamp}"

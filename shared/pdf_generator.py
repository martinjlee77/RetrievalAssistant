...
def generate_pdf_from_markdown(markdown_content: str) -> Optional[bytes]:
    ...
    try:
        ...
        for line in lines:
            ...
            # Check if this is disclaimer content (small tag or contains disclaimer text)
            is_disclaimer = (
                'disclaimer' in clean_line.lower() or
                'veritaslogic.ai' in clean_line.lower() or
                'generated by' in clean_line.lower() or

...
def generate_pdf_from_markdown(markdown_content: str) -> Optional[bytes]:
    ...
    try:
        ...
        for line in lines:
            ...
            # Check if this is disclaimer content (ultra-specific phrases only)
            is_disclaimer = (
                'generated by veritaslogic.ai' in clean_line.lower() or
                'makes no representations or warranties' in clean_line.lower() or
                'assumes no responsibility' in clean_line.lower() or
                'industry-standard security controls' in clean_line.lower() or
                'encryption in transit and at rest' in clean_line.lower() or
                'this is not an audit, review, assurance' in clean_line.lower() or
                'not intended for third-party reliance' in clean_line.lower() or
                'disclaimer version:' in clean_line.lower() or
                'veritaslogic.ai employs' in clean_line.lower() or
                'no system can guarantee absolute security' in clean_line.lower() or
                clean_line.startswith('<small>') or
                ('effective' in clean_line.lower() and 'version' in clean_line.lower())
            )

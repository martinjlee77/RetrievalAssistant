...
class AuditPackGenerator:
    ...
    def extract_references_from_memo(self, memo_content: str, filename: str = None) -> List[Dict[str, str]]:
        """
    ...
    def generate_audit_pack_pdf(self, memo_content: str, analysis_id: str, 
                               filename: str = None, customer_name: str = None) -> bytes:
        """
    ...
    def add_audit_pack_download(self, memo_content: str, analysis_id: str, 
                               filename: str = None, customer_name: str = None) -> None:
        """

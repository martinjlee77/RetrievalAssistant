...
# Import fpdf as module to avoid namespace conflicts with weasyprint
import fpdf
...
class AuditPackGenerator:
    ...
    def generate_audit_pack_pdf(self, memo_content: str, analysis_id: str, 
        ...
        try:
            ...
            # Create PDF using module import to avoid namespace conflicts
            pdf = fpdf.FPDF()
            pdf.add_page()
            ...
            # Return minimal PDF on error using module import
            pdf = fpdf.FPDF()
            pdf.add_page()
            pdf.set_font('Arial', '', 12)

...
class DisclaimerGenerator:
    ...
    def get_top_banner() -> str:
        ...
        return f"""*Disclaimer Version: [v1.0] (Effective [08/23/2025])*
...
*VeritasLogic.ai employs industry-standard security measures designed to protect confidentiality, integrity, and availability, including encryption in transit and at rest, role-based access controls, and logging/monitoring. No system can guarantee absolute security. Data handling and retention are governed by the VeritasLogic.ai Terms of Service and Privacy/Security documentation available at [Security Overview URL] and [Privacy Policy URL]. For security inquiries, contact support@veritaslogic.ai.*
...
*To the fullest extent permitted by law, VeritasLogic.ai and its affiliates, licensors, and suppliers disclaim all liability for any losses, damages, penalties, or costs arising from or related to the use of, reliance on, or inability to use this memorandum or the Platform, whether direct, indirect, incidental, consequential, special, exemplary, or punitive. Any liability that cannot be disclaimed is limited as set forth in the VeritasLogic.ai Terms of Service. Nothing herein limits any rights under applicable consumer protection laws.*

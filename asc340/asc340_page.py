...
def get_asc340_inputs_new():
    ...
    uploaded_files = st.file_uploader(
        "1️⃣ Upload commission and related documents - PDF or DOCX files, max 5 files - **FILE SIZE LIMIT:** Widget shows 200MB but our business limit is 50MB per file (required)",
        type=['pdf', 'docx'],
